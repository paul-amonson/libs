...
class RedisUniqueIdSpec extends Specification {
    ...
    void setup() {
        ...
        transaction_.incrBy(spock.lang.Specification._ as String, spock.lang.Specification._ as Long) >> response_
        transaction_.del(spock.lang.Specification._ as String) >> Mock(Response)
