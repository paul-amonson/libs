...
class ConfigLoaderSpec extends Specification {
    Jedis createMockInstance(HostAndPort authority) {
        ...
        instance.hexists(spock.lang.Specification._ as String, spock.lang.Specification._ as String) >> true
        instance.hget(spock.lang.Specification._ as String, spock.lang.Specification._ as String) >> "{}"
        return instance
    }
